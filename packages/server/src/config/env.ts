...
const envSchema = z.object({
  DATABASE_URL: z.string().url().default('postgresql://tcgplayer:tcgplayer@localhost:5432/tcgplayer'),
  TCGTRACKING_BASE_URL: z.string().url().default('https://tcgtracking.com/tcgapi/v1'),
